  ...
  <div class="card-body">
    ...
    <div class="form-row">
      ...
      <div class="col-md-2 mb-2">
        ...
        <?php echo form_dropdown('year', $years, [$product->year], ['class' => 'form-control selectpicker', 'data-live-search' => 'true', 'title' => 'Pilih Unit Tahun']) ?>
        <div class="small text-danger">
    ...
    <div class="form-row">
      ...
      <div class="col-md-5 mb-2">
        ...
        <div class="input-group">
          ...
          <?php echo form_input(['name' => 'down_payment', 'data-mask' => '000,000,000,000,000', 'data-mask-reverse' => 'true', 'id' => 'product-down_payment', 'class' => 'form-control', 'placeholder' => 'Uang Muka Unit Kendaraan', 'value' => $product->down_payment]) ?>
        </div>
        <div class="small text-danger">
