  ...
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-6">
        <?php echo form_dropdown('lease_id', $leases, $credit->lease_id, ['class' => 'form-control', 'id' => 'credit-lease_id']) ?>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-6">
        <?php echo form_input(['name' => 'down_payment', 'id' => 'credit-down_payment', 'class' => 'form-control', 'placeholder' => 'Uang Muka', 'value' => $credit->down_payment]) ?>
      </div>
      <div class="col-xs-12 col-lg-4">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-6">
        <?php echo form_input(['name' => 'tenor', 'id' => 'credit-tenor', 'class' => 'form-control', 'placeholder' => 'Tenor Kredit', 'value' => $credit->tenor]) ?>
      </div>
      <div class="col-xs-12 col-lg-4">
    ...
    <div class="form-group">
      <?php echo form_label('Persentase', 'credit-persentase', ['class' => 'control-label col-xs-12 col-lg-2']) ?>
      <div class="col-xs-12 col-lg-6">
        <?php echo form_input(['name' => 'percentage', 'id' => 'credit-persentase', 'class' => 'form-control', 'placeholder' => 'Persentase Kredit', 'value' => $credit->percentage]) ?>
      </div>
      <div class="col-xs-12 col-lg-4">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-6">
        <?php echo form_input(['name' => 'tax', 'id' => 'credit-tax', 'class' => 'form-control', 'placeholder' => 'Pajak Kredit', 'value' => $credit->tax]) ?>
      </div>
      <div class="col-xs-12 col-lg-4">
