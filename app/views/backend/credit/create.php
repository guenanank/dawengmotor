  ...
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-8">
        <?php echo form_dropdown('lease_id', $leases, null, ['class' => 'form-control selectpicker', 'id' => 'credit-lease_id']) ?>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-lg-8">
        <div class="input-group mb-3">
          <?php echo form_input(['name' => 'down_payment', 'data-mask' => '00.00', 'id' => 'credit-down_payment', 'class' => 'form-control', 'placeholder' => 'Uang Muka', 'value' => set_value('down_payment')]) ?>
